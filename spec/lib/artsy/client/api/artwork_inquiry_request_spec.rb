...
describe Artsy::Client::API::ArtworkInquiryRequest do
  ...
  describe "#artwork_inquiry_request" do
    before do
      stub_get("/api/v1/inquiry_request/ludvik").to_return(
    ...
    it "returns artwork_inquiry_request" do
      ...
      expect(a_get("/api/v1/inquiry_request/ludvik")).to have_been_made
  ...
  describe "#artwork_inquiry_requests" do
    before do
      stub_get("/api/v1/inquiry_requests").to_return(
    ...
    it "returns artwork inquiry requests" do
      ...
      expect(a_get("/api/v1/inquiry_requests")).to have_been_made
